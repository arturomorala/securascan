...
# Apply SecuraScan v0.6 scanner engine overlay.
COPY scanner_v06_chunks /tmp/scanner_v06_chunks
RUN cat /tmp/scanner_v06_chunks/chunk*.txt | base64 -d > /tmp/scanner_v06_overlay.zip \
    && unzip -t /tmp/scanner_v06_overlay.zip \
    && unzip /tmp/scanner_v06_overlay.zip -d /tmp/scanner_v06_overlay \
    && cp -a /tmp/scanner_v06_overlay/securascan/. /app/ \
    && rm -rf /tmp/scanner_v06_chunks /tmp/scanner_v06_overlay /tmp/scanner_v06_overlay.zip
